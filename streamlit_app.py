...
from streamlit_pages._detect_alzheimer import alzheimer_detection
...
app_mode = st.sidebar.selectbox(
    ...
    ["Home", "Predict Alzheimer's", "ChatBot", "Latest News", "Team Members", "Detect Alzheimer"]
)
